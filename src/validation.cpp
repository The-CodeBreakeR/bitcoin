...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    CAmount nSubsidy = 40 * COIN; // changed by The_CodeBreakeR, the original value was 50
    // Subsidy is cut in half every 210,000 blocks which will occur approximately every 4 years. // That changed by The_CodeBreakeR
    nSubsidy >>= halvings;
    return nSubsidy;
}
